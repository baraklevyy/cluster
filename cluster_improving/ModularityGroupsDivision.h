...
void modularity_division_rec(struct _spmat *A, int *k, int M, double *s, double *f, double L1_NORM, int number_of_1,
                             ...
                             int *onces_helper, node **outer_array_helper,
                             int *number_of_groups, int *number_of_written_elements, FILE *write_ptr, int * output_array, int *relevant_indices_helper);
